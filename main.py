        ...
        for j in week:
            if (day == j[0] and month == j[1] and year == int(j[2])):
                ...
                if cvobodn ==1:
                    for p in i[5]:
                        j[6][p-1][0] = 'CCC'
                    vihod.append([i[0]+" "+i[1], day, month, year,i[7], i[8],502,6])
                    also_find = 1
                    break
                cvobodn = 1
                for p in i[5]:
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p-1][6] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 513, 6])
                    also_find = 1
                    break
        if (also_find==0):
            for j in week6:
                if (day == j[0] and month == j[1] and year == int(j[2])):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][0] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 105, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][32] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][32] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 307, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][36] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][36] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 314, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][42] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][42] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 324, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][43] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][43] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 328, 2])
                        break
                    if cvobodn == 0:
                        vihod.append([" ","no free room", i[0] + " " + i[1], day, month, year, i[7], i[8]])
for i in req:
    if i[6] != 'big':
        day = i[2]
        month = i[3]
        ...
        for j in week:
            if (day == j[0] and month == j[1] and year == int(j[2])):
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][1] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 506, 6])
                    also_find = 1
                    break
                cvobodn = 1
                for p in i[5]:
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][2] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 508, 6])
                    also_find = 1
                    break
                cvobodn = 1
                cvobodn = 1
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][3] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 509, 6])
                    also_find = 1
                    break
                cvobodn = 1
                for p in i[5]:
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][4] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 511, 6])
                    also_find = 1
                    break
                cvobodn = 1
                for p in i[5]:
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][5] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 512, 6])
                    also_find = 1
                    break
                for p in i[5]:
                    if (j[6][p-1][6] != ''):
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][7] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 514, 6])
                    also_find = 1
                    break
                cvobodn = 1
                for p in i[5]:
                ...
                if cvobodn == 1:
                    for p in i[5]:
                        j[6][p - 1][8] = 'CCC'
                    vihod.append([i[0]+" "+i[1],day, month, year, i[7], i[8], 515, 6])
                    also_find = 1
                    break
        if also_find ==0:
            for j in week6:
                if (day == j[0] and month == j[1] and year == int(j[2])):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][33] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 309, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][36] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][37] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 317, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][39] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][39] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 318, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][41] != ''):
                    ...
                    if cvobodn == 1:
                        for p in i[5]:
                            j[6][p - 1][41] = 'CCC'
                        vihod.append([i[0] + " " + i[1], day, month, year, i[7], i[8], 322, 2])
                        break
                    cvobodn = 1
                    for p in i[5]:
                        if (j[6][p - 1][42] != ''):
